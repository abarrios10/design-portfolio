...
const projects = [
  ...
  },
  {
    ...
    details: "Team-based Mars rover design for NASA's L'SPACE Academy to traverse Martian terrain and collect soil and ice samples for analysis. Collaborated with other student engineers to coordinate the design review, verify subsystem constraints, and ensure the design met strict mass, volume, and cost limits. My main contributions were the robotic arm and camera attachment, all designed in SolidWorks in collaboration with one other engineer on the team.",
      ...
      return (
        <>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              The wind turbine generates three-phase AC power that varies with wind speed and requires conditioning for reliable LED operation. The core circuit implements a half-wave rectifier using silicon diodes to convert the alternating current to pulsating DC, effectively removing the negative portions of the AC waveform. A large electrolytic capacitor (1000μF) is strategically placed after the rectifier to smooth the pulsating DC output, reducing voltage ripple and creating a more stable power supply for the LED indicators.
              <br /><br />
