        ...
        <Card className="bg-card rounded-2xl shadow-lg p-12">
          <CardContent className="p-0 space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                <div className="w-20 h-20 rounded-xl flex items-center justify-center transition-all mb-4 bg-primary/10">
            ...
            {/* Centered Location */}
            <div className="flex flex-col items-center text-center p-8 rounded-xl">
              <div className="w-20 h-20 rounded-xl flex items-center justify-center mb-4 bg-primary/10">
                <MapPin className="h-10 w-10 text-primary" />
              </div>
              <p className="text-xl font-semibold text-card-foreground mb-2">Location</p>
