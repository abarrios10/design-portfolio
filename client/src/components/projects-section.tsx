      ...
      return (
        <>
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">This Amazon Robotics project involved mechanical engineering design and development work on the new generation autonomous robotic drive-unit. Detailed project information and technical specifications are proprietary and cannot be shared publicly. An image of the previous generation drive is provided below for context.</p>
          </div>
          <div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {projects.map((project) => (
            <Card key={project.id} className="project-card group overflow-hidden relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-2 border-gray-300 dark:border-gray-600" data-testid={`card-project-${project.id}`}>
              <CardHeader>
              ...
              <CardContent className="relative">
                ...
                {project.id === 2 || project.id === 3 || project.id === 4 ? (
                  ...
                  (<div className="absolute bottom-2 right-4 bg-white/90 dark:bg-gray-800/90 p-1 rounded">
                    <>
                      <img 
