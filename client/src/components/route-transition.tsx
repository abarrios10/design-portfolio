...
export function PageTransitionProvider({ children }: PageTransitionProviderProps) {
  ...
  const getPhaseClass = () => {
    switch (phase) {
      case 'exiting': return 'page-exit';
      case 'entering': return 'page-enter';
      default: return '';
    }
  };
...
export function TransitionLink({ href, children, className = '', 'data-testid': testId }: TransitionLinkProps) {
