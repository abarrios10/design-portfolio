      ...
      return (
        <>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">The operator recommended me the solution that would be the most appropriate would be to install a drainage line and drainpipe with an updated steam trap system that had been implemented into the refinery a couple of years prior in a separate unit. He wasn't familiar with the exact name of the set up, but seeing it gave me an idea of where to go with my replacement. An image of the system I wanted to utilize with my design is shown below:</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              {/* Space for images */}
            </div>
          </div>
